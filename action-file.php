...
/** include_once("../ipost/signup/signup.php");
include("../ipost/system_Info.php"); **/ 
/**$link=connection_db ();**/
...
if($_POST["EmailFrom"] == $_POST["EmailConfirm"] && $_POST["EmailFrom"])
{
	...
	$IpostList = $_POST["subclient"] ? $_POST["subclient"] : 'liosfulfillment'; 
   ...
   $oid = '00Di0000000gueC';
                      ...
                      $sourcecodecheckbox = 1;
                        ...
                        $params = 'first_name=' . $First_Name .
                                  ...
                                  '&00N6e00000MRIX4=' . $SourceCode .
                                  '&00N6e00000MRIWz=' . $SaleForce .
	 ...
	 /**ipost **/
		...
		if($SubscribeTo){
			...
			$ipost_vars="?email=".$EmailFrom."&list=".$SubscribeTo."&sc=".$SourceCode." ";
		 
		 /**$call = new signup();
		 
		$Response = $call->Signup_Contact($EmailFrom, $SourceCode, $SubscribeTo, $formdesc,$ThankYou,$failurl);	 **/
	...
	$AutomationsArray = array
           ...
           $http_status = curl_getinfo($curl, CURLINFO_HTTP_CODE);
        	...
        	$options = array
			  (					
            	CURLOPT_URL => "https://g001.enterprise.ipost.com/api/v1/". $IpostList ."/automations/journey/". $AutoResponder . "/addContacts/",  	       
	 		    CURLOPT_FRESH_CONNECT => 1,
                CURLOPT_RETURNTRANSFER => 1,   
...
if($finsert_leads || $fLeads_To_Project){
	echo' <script type="text/javascript">
           window.location.href = "'.$ThankYou.''.$ipost_vars.'"
      </script>'; 
	  exit();
	}
